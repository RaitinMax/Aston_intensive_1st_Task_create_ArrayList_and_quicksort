...
public class ArrayList<T> //дженерик (<T>) для обеспечения параметризации типа элементов, которые могут храниться в списке
{
    ...
    // для добавления элемента в конец коллекции
    ...
    private int partition(int low, int high) {
        ...
        {
            if (((Comparable<T>) get(j)).compareTo(pivot) <= 0)//сравниваем текущий элемент списка с пивотом, используя метод compareTo() интерфейса Comparable.
